...
class Migrate extends Action
{
    ...
    public function __construct()
    {
        $this
            ...
            ->inject('dbForConsole')
            ->inject('getProjectDB')
            ->callback(fn ($version, $pools, $cache, $dbForConsole, $getProjectDB) => $this->action($version, $pools, $cache, $dbForConsole, $getProjectDB));
    }
    ...
    public function action(string $version, Group $pools, Cache $cache, Database $dbForConsole, callable $getProjectDB)
    {
